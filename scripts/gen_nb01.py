"""Generate notebooks/01_data_acquisition.ipynb with valid JSON."""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
NB_PATH = ROOT / "notebooks" / "01_data_acquisition.ipynb"
...
print(f"Notebook 01 written: {len(cells)} cells ({n_md} markdown, {n_code} code)")
