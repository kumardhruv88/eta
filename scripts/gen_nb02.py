"""Generate notebooks/02_eda_and_stats.ipynb with valid JSON."""
import json, pathlib

ROOT = pathlib.Path(__file__).parent.parent
NB_PATH = ROOT / "notebooks" / "02_eda_and_stats.ipynb"
...
print(f"Notebook 02 written: {len(cells)} cells ({n_md} markdown, {n_code} code)")
