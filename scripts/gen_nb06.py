"""Generate notebooks/06_evaluation_and_error_analysis.ipynb."""
import json, pathlib

ROOT    = pathlib.Path(__file__).parent.parent
NB_PATH = ROOT / "notebooks" / "06_evaluation_and_error_analysis.ipynb"
...
print(f"Notebook 06 written: {len(cells)} cells ({n_md} md, {n_code} code)")
